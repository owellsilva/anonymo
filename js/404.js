...
$(document).ready(function(){
  $('.err-rprt-cvr').hide();
  $('.prog').hide();
  var quips = ["Estos no son los archivos que buscas.","La pagina de momento esta en desarrollo","Vaya, nuestra culpa.","Podría haber jurado que vi ese archivo hace una semana...","Debe ser algun problema en el servidor","Estaba aquí..." ,"Lo siento, pero la pagina no esta disponible", "me temo que no puedo encontrar la pagina", "Bueno, entonces..."];
